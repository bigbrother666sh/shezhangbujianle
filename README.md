# update
浪潮源1.0刚进行了模型升级，现在的对话模型比基础模型增加了不少常识性知识，从而使zero-shot下的开放域对话效果也非常不错！

~~为此，我提供了一版脱离剧情的"蔡晓"，未来24小时内（至2020年5月8日中午12时），~~ 大家可以通过扫描如下二维码添加阿瓦达啃大瓜🍉，尝试跟她聊聊本作剧情，或者也可以听听看她对我们人类的看法
*（本次体验已经结束，大家感兴趣依然可以扫码添加"蔡晓"，静候她的下次觉醒。下一次，她将带着更智慧、更丰富的能力与大家见面！【具体信息将通过她的朋友圈不定期更新】）*

 <img alt="img" height="516" src="/assets/7661651902756_.pic.jpg" width="516"/>

**注意：您发给机器人账号的任何消息都将被视为不涉及任何隐私信息，相关的信息泄露风险也都将由您自行承担，同时您确认您与机器人之间的对话是可以公开的，您本人需要承担由您发出的任何不当言论的法律风险。

添加机器人账号意味着您理解并接受上述声明！**

因服务器容量以及微信相关政策限制，我将采用人工方式分批接受添加申请，请您发出好友申请后，耐心等待。

"蔡晓问答"版本的example语料文件~~稍后~~会开源。已上传，见home/cxzf.txt运行程序 为/caixiao.py

注：我们已经升级使用puppet-padlocal，有兴趣自行部署的同学，建议从这里起步：[Python Wechaty geeting started](https://github.com/wechaty/python-wechaty-getting-started/)
...
原理很简单，就是把之前若干轮次用户与AI的对话存在一个列表里面，然后提交生成的时候把这个列表和当前问题文本join一下，当然具体实施的时候，我们需要调整下提交的pre-fix和输出的pre-fix这些……我们一开始比较担心的是，这种记忆机制会不会跟example的few-shot机制有冲突，毕竟example都是
