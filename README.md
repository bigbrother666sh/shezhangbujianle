...
我们相信这种**内容编辑与工程代码的混同创作**会是一种适应NLP大模型的崭新“开发范式”，它不仅仅可以应用于娱乐内容，其他领域诸如教育、客服、销售、政务、心理情感等涉及到“目的性对话”的领域均可以尝试。
...
另外，我们也很感谢华东理工大学图书馆的吉久明教授授予我们原作的改编权，同时还无偿贡献了配套的“角色选择心理测验“，通过16到是否题，就可以比较精确的匹配到更玩家性格特征最贴近的角色，从而让整个游戏的沉浸感更加强烈，个人认为，这倒是每一个剧本杀都值得引入的一个系统。

感谢浪潮源1.0团队、百度飞桨团队，感谢github和csdn，本项目实现过程中
